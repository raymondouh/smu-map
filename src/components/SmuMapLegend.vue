        ...
        <div class="legend-body">
            <svg width="38" height="305" viewBox="0 0 38 305" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
                ...
                <g id="SMU-scale-block-1">
                    <title>{{rangeLegend.range[7][0]}} - {{rangeLegend.range[7][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-2">
                    <title>{{rangeLegend.range[6][0]}} - {{rangeLegend.range[6][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-3">
                    <title>{{rangeLegend.range[5][0]}} - {{rangeLegend.range[5][1]}} чел.</title>
                    <path class="path-stroke"
                ...
                <g id="SMU-scale-block-4">
                    <title>{{rangeLegend.range[4][0]}} - {{rangeLegend.range[4][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-5">
                    <title>{{rangeLegend.range[3][0]}} - {{rangeLegend.range[3][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-6">
                    <title>{{rangeLegend.range[2][0]}} - {{rangeLegend.range[2][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-7">
                    <title>{{rangeLegend.range[1][0]}} - {{rangeLegend.range[1][1]}} чел.</title>
                ...
                <g id="SMU-scale-block-8">
                    <title>{{rangeLegend.range[0][0]}} - {{rangeLegend.range[0][1]}} чел.</title>
